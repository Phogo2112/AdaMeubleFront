...
export function ProposeProductPage() {
  ...
  const [successMessage, setSuccessMessage] = useState<string | null>(null); // ✅ AJOUT 1
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('Erreur proposition produit:', err);
      setError(err.response?.data?.message || 'Erreur lors de la proposition du produit');
    } finally {
      setLoading(false);
    }
  };
      ...
      <form className="product-form" onSubmit={handleSubmit}>
        ...
        <div className="form-actions">
          ...
          <button
            ...
            disabled={loading}
          >
            {loading ? 'Proposition en cours...' : 'Proposer le meuble'}
          </button>
        </div>
      </form>
    </div>
